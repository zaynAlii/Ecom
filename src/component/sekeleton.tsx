...
const sekeleton = () => {
  return (
         <>
          <div
            role="status"
            className="max-w-sm p-4 mb-24  border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700"
        >
            ...
            <div
                role="status"
                className="max-w-sm p-4 my-24  border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700"
            >
                <div className="flex items-center justify-center h-48 mb-4 bg-gray-300 rounded dark:bg-gray-700">
                    <svg
                        className="w-12 h-12 text-gray-200 dark:text-gray-600"
